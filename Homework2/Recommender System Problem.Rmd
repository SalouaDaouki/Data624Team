...
Now, let's plot the top 10 items by their frequencies in a histogram to visualize the most frequent items:
...
Let's sort the rules by lift for further see the most associated item:
...
The representation based on the confidence value, rule6 stands out as the strongest one; that item or group of items are more likely to be purchased by customers who buy citrus fruit, soft cheese and root vegetables. In the other direction, customers who buy the items in rule 6 are more likely to buy other vegetables as well.
